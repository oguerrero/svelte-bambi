	...
	{#if isInView}
		<div in:fade>
			<h1 class="text-center py-8">
				<span
					class="border-4 border-black py-2 px-4 text-3xl font-bold text-black"
					>Programa</span
				>
			</h1>
			...
			>
				<div class="card bg-base-100 shadow-lg  shadow-secondary">
					<div class="card-body items-center flex md:flex-row ">
						...
						<div class="justify-center flex-col">
							<h2 class="card-title justify-center items-center pb-4">
								Kinder 1
							</h2>
							<p
								class="text-center text-xs font-semibold text-gray-500 md:pl-8"
							>
								Adquirirán confianza, seguridad, percepción de si mismos al
								integrarse en un ambiente socializador desarrollando habilidades
								de conversación e intercambio de ideas.
							</p>
						</div>
					</div>
				</div>
				<div class="card bg-base-100 shadow-lg  shadow-secondary">
					<div class="card-body items-center flex md:flex-row">
						...
						<div class="justify-center flex-col">
							<h2 class="card-title justify-center items-center pb-4">Kinder 2</h2>
							<p
								class="text-center text-xs font-semibold text-gray-500 md:pl-8"
							>
								Practica hábitos de prelectura, registra, socializa, clasifica,
								inventa y resuelve problemas matemáticos. Observa y cuida el
								medio ambiente.
							</p>
						</div>
					</div>
				...
				<div class="card bg-base-100 shadow-lg  shadow-secondary">
					<div class="card-body items-center flex md:flex-row">
						...
						<div class="justify-center flex-col">
							<h2 class="card-title justify-center items-center pb-4">Kinder 3</h2>
							<p
								class="text-center text-xs font-semibold text-gray-500 md:pl-8"
							>
				...
				<div class="card bg-base-100 shadow-lg  shadow-secondary">
					<div class="card-body items-center flex md:flex-row">
						...
						<div class="justify-center flex-col">
							<h2 class="card-title justify-center items-center pb-4">Inglés</h2>
							<p
								class="text-center text-xs font-semibold text-gray-500 md:pl-8"
							>
					...
					<div class="card-body items-center flex md:flex-row">
						...
						<div class="justify-center flex-col">
							...
							>
								...
								cálculo, procesador de textos e inserción de imágenes, para que
								vean a la computadora como una herramienta para procesar
								información y no cómo un objeto para videojuegos.
							</p>
						</div>
					</div>
				</div>
				<div class="card bg-base-100 shadow-lg  shadow-secondary">
					<div class="card-body items-center flex md:flex-row">
						...
						<div class="justify-center flex-col">
							...
							<p
								class="text-center text-xs font-semibold text-gray-500 md:pl-10"
							>
								La Educación Física es una forma de intervención pedagógica que
								contribuye a la formación integral de niñas, niños y
