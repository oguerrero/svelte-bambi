...
<section
	class=" px-8 py-8 md:px-28 bg-slate-200 mix-blend-multiply scroll-m-16 md:scroll-m-10"
	id="nosotros"
...
>
	{#if isInView}
		<div in:fade>
			...
			<h3 class="text-center py-8 text-sm font-bold text-gray-600">
				Ternura y Educación desde 1989
			</h3>
			<article
				class="grid grid-cols-2 grid-rows-4 md:grid-cols-4 md:grid-rows-2 gap-4"
			>
				<div class="card bg-base-100 shadow-lg shadow-primary">
				...
				<div class="card bg-base-100 shadow-lg shadow-primary">
					<div class="card-body items-center">
						...
						<p class="text-center text-xs font-semibold text-gray-500">
							...
							para que a través de su vida logren tomar las mejores decisiones.
						</p>
					</div>
				</div>
				<div class="card bg-base-100 shadow-lg shadow-primary">
					<div class="card-body items-center">
						...
						<p class="text-center text-xs md:font-semibold text-gray-500">
							Formar niños reflexivos, creativos y autónomos, comprometidos con
							sí mismos, con sus ideales y con la familia.
						</p>
					</div>
				</div>
				<div class="card bg-base-100 shadow-lg shadow-primary">
				...
				<div class="card bg-base-100 shadow-lg shadow-primary">
					<div class="card-body items-center">
						...
						<p class="text-center text-xs font-semibold text-gray-500">
							Contamos con redes sociales para dar avisos importantes.
						</p>
					</div>
				</div>
			</article>
